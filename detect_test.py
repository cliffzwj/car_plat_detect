import os
import hyperlpr_py3.detect as hyperDetect
import hyperlpr_py3.config as hyperConfig
# from hyperlpr_py3 import detect as hyperDetect
# from hyperlpr_py3 import config as hyperConfig
import cv2
import argparse
import sys
...
def drawBoundingBox(originImage, rect):
    cv2.rectangle(originImage, (int(rect[0]), int(rect[1])), (int(rect[0] + rect[2]), int(rect[1] + rect[3])),
                  (0, 0, 255), 2,
                  cv2.LINE_AA)
    return originImage
